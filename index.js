...
function buildConfigPage(baseUrl) {
  ...
  h += '<footer>Multi Source Audiobook Addon v1.0.0 &bull; Powered by LibriVox, Loyal Books, Internet Archive &amp; Open Culture &bull; <a href="' + baseUrl + '/health" target="_blank">Health</a></footer>';
...
app.get('/u/:token/stream/:id', tokenMiddleware, async function(req, res) {
  ...
  if (id.startsWith('ia_tr_') || id.startsWith('lb_tr_')) {
...
app.listen(PORT, () => console.log('Multi Source Audiobook Addon v1.0.0 on port ' + PORT));
